...
The Optoisolation can handle a forward current of 40 ma. Since information came from the datasheet and the voltage divider will be created to produce a current below 40 mA.
